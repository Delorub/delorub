Rails.application.config.assets.tap do |assets|
  ...
  assets.precompile += %w[admin.js website-bundle.js website_apps-bundle.js contract_app-bundle.js contract_designer_app-bundle.js] # contract_designer_app-bundle.js
