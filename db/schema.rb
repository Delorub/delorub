...
ActiveRecord::Schema.define(version: 20171114103406) do
  ...
  create_table "portfolio_temporary_covers", force: :cascade do |t|
    t.string "cover"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "subcategories_tasks", force: :cascade do |t|
    t.integer "subcategory_id"
    t.integer "task_id"
    t.index ["subcategory_id", "task_id"], name: "index_subcategories_tasks_on_subcategory_id_and_task_id", unique: true
  end
  ...
  create_table "user_billing_logs", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "state"
    t.integer "finish_after_billing_log_id"
  end

  create_table "user_logs", force: :cascade do |t|
    t.bigint "user_id"
    t.string "operational_type"
    t.bigint "operational_id"
    t.string "log_type"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["operational_type", "operational_id"], name: "index_user_logs_on_operational_type_and_operational_id"
